...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/fp_sqr_memoryC0_uid62_sqrtTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_sqr_memoryC1_uid65_sqrtTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_sqr_memoryC2_uid68_sqrtTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_sqr.vo"
fi
