...
# ACDS 18.1 625 win32 2021.05.07.14:43:57
# ----------------------------------------
...
# ----------------------------------------
# If fp_sqr is one of several IP cores in your
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/fp_sqr_memoryC0_uid62_sqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_sqr_memoryC1_uid65_sqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_sqr_memoryC2_uid68_sqrtTables_lutmem.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_sqr.vo"
}
