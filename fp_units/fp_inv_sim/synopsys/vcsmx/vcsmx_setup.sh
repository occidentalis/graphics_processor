...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/fp_inv_memoryC0_uid60_inverseTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_inv_memoryC1_uid63_inverseTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_inv_memoryC2_uid66_inverseTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_inv.vo"
fi
