...
# ACDS 18.1 625 win32 2021.05.11.07:18:15
# ----------------------------------------
...
# ----------------------------------------
# If fp_inv is one of several IP cores in your
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/fp_inv_memoryC0_uid60_inverseTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_inv_memoryC1_uid63_inverseTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_inv_memoryC2_uid66_inverseTables_lutmem.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_inv.vo"
}
