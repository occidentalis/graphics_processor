...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/fp_cos_memoryC0_uid144_cosPiXTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_cos_memoryC1_uid147_cosPiXTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_cos_memoryC2_uid150_cosPiXTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_cos.vo"
fi
