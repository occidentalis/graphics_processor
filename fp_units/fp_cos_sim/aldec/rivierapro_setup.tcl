...
# ACDS 18.1 625 win32 2021.05.11.07:32:07
# ----------------------------------------
...
# ----------------------------------------
# If fp_cos is one of several IP cores in your
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/fp_cos_memoryC0_uid144_cosPiXTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_cos_memoryC1_uid147_cosPiXTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_cos_memoryC2_uid150_cosPiXTables_lutmem.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_cos.vo"
}
