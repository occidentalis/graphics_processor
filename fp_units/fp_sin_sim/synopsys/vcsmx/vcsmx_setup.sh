...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/fp_sin_memoryC0_uid155_sinPiXTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_sin_memoryC1_uid158_sinPiXTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fp_sin_memoryC2_uid161_sinPiXTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_sin.vo"
fi
