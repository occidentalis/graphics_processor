...
# ACDS 18.1 625 win32 2021.05.11.07:31:04
# ----------------------------------------
...
# ----------------------------------------
# If fp_sin is one of several IP cores in your
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/fp_sin_memoryC0_uid155_sinPiXTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_sin_memoryC1_uid158_sinPiXTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fp_sin_memoryC2_uid161_sinPiXTables_lutmem.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_sin.vo"
}
